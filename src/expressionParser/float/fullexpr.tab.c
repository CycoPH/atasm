...
#define yyparse         floatparse
#define yylex           floatlex
#define yyerror         floaterror
#define yylval          floatlval
#define yychar          floatchar
#define yydebug         floatdebug
#define yynerrs         floatnerrs
...
{
      21,     0,    -1,    22,    -1,    17,    -1,    13,    22,    -1,
      10,    22,    -1,    22,     9,    22,    -1,    22,    10,    22,
      -1,    22,    11,    22,    -1,    22,    12,    22,    -1,    22,
       5,    22,    -1,    22,     6,    22,    -1,    22,     8,    22,
      -1,    22,     7,    22,    -1,    22,     3,    22,    -1,    22,
       4,    22,    -1,    18,    22,    19,    -1
};
...
{
  "$end", "error", "$undefined", "'='", "'#'", "'<'", "'>'", "'G'", "'L'",
  "'+'", "'-'", "'*'", "'/'", "'N'", "'!'", "'R'", "'D'", "'v'", "'['",
  "']'", "$accept", "expr", "expression", 0
};
#endif
...
{
       0,   256,   257,    61,    35,    60,    62,    71,    76,    43,
      45,    42,    47,    78,    33,    82,    68,   118,    91,    93
};
# endif
